  ...
  <div class="container">
    <div class="footer-top">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-nav-list">
          ...
          <li><a href="assets/downloads/pdf/AinZara-Master-Architectural-Catalog.pdf" class="footer-nav-link" download="AinZara-Master-Architectural-Catalog.pdf" target="_blank" style="color: #60A5FA; font-weight: 600; display: inline-flex; align-items: center; gap: 0.35rem;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg><span data-i18n="drawer_download_catalog">Catalog PDF</span> (2026)</a></li>
        </ul>
      </div>
      <div class="footer-col">
    ...
    <div class="footer-bottom">
      ...
      <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
        ...
        <span>&bull;</span>
        <button type="button" class="lang-btn lang-toggle-btn footer-lang-btn" aria-label="Toggle Language">
